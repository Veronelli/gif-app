// To parse this data:
//
//   import { Convert, SeachGifsResponse } from "./file";
//
//   const seachGifsResponse = Convert.toSeachGifsResponse(json);
//
...
export class Convert {
    public static toSeachGifsResponse(json: string): SeachGifsResponse {
        return cast(JSON.parse(json), r("SeachGifsResponse"));
    }

    public static seachGifsResponseToJson(value: SeachGifsResponse): string {
        return JSON.stringify(uncast(value, r("SeachGifsResponse")), null, 2);
    }
}
